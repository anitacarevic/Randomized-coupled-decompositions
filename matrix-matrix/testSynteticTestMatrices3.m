...
[X, Y] = SyntheticTestMatrices3(m,n,r);
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
kr = 1;
rezRBKIl1 = zeros(46,2);
dimRBKIl1 = zeros(46,1);
timeRBKIl1 = zeros(46,2);
for q=15:60
    start = tic;
    [URBKIl1, VRBKIl1, WRBKIl1, ~, r, t] = RandCmfRBKI(X, Y, kr, kr, q, q, k);
    timeRBKIl1(q-14,1) = toc(start);
    timeRBKIl1(q-14,2) = t;
    dimRBKIl1(q-14) = r;
...
kr = 2;
rezRBKIl2 = zeros(23,2);
dimRBKIl2 = zeros(23,1);
timeRBKIl2 = zeros(23,2);
for q=8:30
    start = tic;
    [URBKIl2, VRBKIl2, WRBKIl2, ~, r, t] = RandCmfRBKI(X, Y, kr, kr, q, q, k);
    timeRBKIl2(q-7,1) = toc(start);
    timeRBKIl2(q-7,2) = t;
    dimRBKIl2(q-7) = r;
